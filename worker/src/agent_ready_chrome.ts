...
const SHARED_STYLE = `<style>
  ...
  * { box-sizing: border-box; }
  ...
  .path.featured { background: linear-gradient(135deg, var(--card), rgba(255,158,44,.08)); border-color: var(--accent); }
  ...
  .checklist { background: linear-gradient(135deg, rgba(74,222,128,.06), rgba(255,176,0,.04)); border: 1px solid rgba(74,222,128,.25); border-radius: 14px; padding: 26px; margin-top: 22px; }
