...
export function ogSvg(): string {
  ...
  <text x="72" y="96" font-family="-apple-system, system-ui, 'Segoe UI', sans-serif"
    ...
    wmcp<tspan fill="#00e5ff">.sh</tspan>
  </text>

  <!-- badge -->
  <g transform="translate(72, 128)">
    <rect width="252" height="36" rx="18" fill="#16161f" stroke="#7c5cff" stroke-opacity="0.4"/>
    <circle cx="22" cy="18" r="4" fill="#00e5ff"/>
  ...
  <g transform="translate(72, 458)">
    ...
    <text x="22" y="44" font-family="'SF Mono', 'Menlo', monospace" font-size="18">
      ...
      <tspan fill="#f0abfc">'https://wmcp.sh/api/v1/tools?url=...'</tspan>
    </text>
  </g>
  ...
  <g transform="translate(990, 285)">
    ...
    <circle cx="0" cy="0" r="170" fill="#7c5cff" fill-opacity="0.18" filter="url(#soft)"/>

    <!-- back face -->
    <rect x="-100" y="-100" width="200" height="200" rx="22"
          fill="url(#cubeFill)" stroke="#7c5cff" stroke-opacity="0.35" stroke-width="2"
          transform="translate(-22, -22)"/>
    <!-- middle face -->
    <rect x="-100" y="-100" width="200" height="200" rx="22"
          fill="url(#cubeFill)" stroke="#00e5ff" stroke-opacity="0.45" stroke-width="2"/>
    <!-- front face -->
    <rect x="-100" y="-100" width="200" height="200" rx="22"
          fill="#16161f" stroke="#7c5cff" stroke-opacity="0.8" stroke-width="2"
          transform="translate(22, 22)"/>
    ...
    <g transform="translate(22, 22)">
      ...
      <line x1="-30" y1="-12" x2="30" y2="-12" stroke="#7c5cff" stroke-width="2" stroke-linecap="round"/>
      <circle cx="-30" cy="-12" r="3" fill="#7c5cff"/>
      <circle cx="30" cy="-12" r="3" fill="#7c5cff"/>
      <!-- arrow down -->
      <path d="M 0 0 L 0 28 L -8 20 M 0 28 L 8 20" fill="none" stroke="#00e5ff" stroke-width="2" stroke-linecap="round"/>
      <text x="0" y="55" text-anchor="middle" font-family="'SF Mono', monospace"
            font-size="14" fill="#00e5ff" font-weight="700">tools[]</text>
    </g>
  </g>
  ...
  <text x="72" y="582" font-family="system-ui, sans-serif" font-size="18"
    ...
    <tspan fill="#00e5ff">github.com/New1Direction/webmcp-anything</tspan>
  </text>
</svg>`;
}
