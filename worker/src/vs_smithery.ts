// /vs/smithery — comparison page. SERP target: "smithery alternative",
// "wmcp.sh vs smithery", "smithery mcp", "smithery competitor".

export function vsSmitheryHtml(origin: string): string {
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<title>wmcp.sh vs Smithery — when each wins, honest comparison | wmcp.sh</title>
<meta name="description" content="Smithery is a local MCP server registry and Docker runner. wmcp.sh is a stateless edge gateway and out-of-band token vault. Here's the honest comparison." />
<link rel="canonical" href="${origin}/vs/smithery" />
<meta property="og:title" content="wmcp.sh vs Smithery — honest head-to-head" />
<meta property="og:description" content="Smithery is a local Docker MCP installer. wmcp.sh is a stateless edge gateway and out-of-band token vault proxy." />
<meta property="og:url" content="${origin}/vs/smithery" />
<meta property="og:image" content="${origin}/og.png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="630" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="wmcp.sh vs Smithery" />
<meta name="twitter:description" content="Honest head-to-head. Local Docker MCP vs stateless edge gateway." />
<meta name="twitter:image" content="${origin}/og.png" />
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"Article","headline":"wmcp.sh vs Smithery — honest head-to-head","description":"Smithery is a local Docker installer. wmcp.sh is an edge-hosted gateway. Different shapes.","author":{"@type":"Organization","name":"WebMCP Anything"},"publisher":{"@type":"Organization","name":"WebMCP Anything","url":"https://wmcp.sh"},"datePublished":"2026-05-28","dateModified":"2026-05-28","mainEntityOfPage":"${origin}/vs/smithery"}
</script>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
  {"@type":"Question","name":"What's the difference between wmcp.sh and Smithery?","acceptedAnswer":{"@type":"Answer","text":"Smithery is a local CLI and hub that lets you install and run Model Context Protocol (MCP) servers locally inside Docker containers. wmcp.sh is a hosted edge gateway proxy that dynamically maps public APIs and storefronts to MCP tools, resolving requests at the edge with built-in out-of-band token vaulting."}},
  {"@type":"Question","name":"When should I pick Smithery?","acceptedAnswer":{"@type":"Answer","text":"Choose Smithery when you are building local workflows on a single developer laptop and want to run existing open-source MCP servers securely in isolated Docker environments locally."}},
  {"@type":"Question","name":"When should I pick wmcp.sh?","acceptedAnswer":{"@type":"Answer","text":"Pick wmcp.sh when building multi-user SaaS web applications, or when you require dynamic, zero-codegen OpenAPI spec resolutions, secure token isolation proxies, or shopper-side storefront integrations at the edge."}}
]}
</script>
<style>
...
<header class="hero">
  ...
  <h1>wmcp.sh vs Smithery.</h1>
  <p class="sub">Smithery is a local MCP server installer using Docker. wmcp.sh is a stateless, edge-hosted gateway and out-of-band proxy vault. Different shapes; here's the honest comparison.</p>
</header>
...
<section id="wedge">
  ...
  <div class="wins-grid">
    <div class="wins-card">
      <h3>Smithery</h3>
      <p style="color:var(--muted);margin:0 0 12px;font-size:.95rem;line-height:1.65">A local CLI tool and registry that compiles and runs existing open-source MCP integration servers locally inside containerized Docker environments.</p>
    </div>
    <div class="wins-card us">
      <h3>wmcp.sh</h3>
      <p style="color:var(--muted);margin:0 0 12px;font-size:.95rem;line-height:1.65">A hosted, stateless edge gateway that maps public APIs and storefront catalogs to standardized MCP tools dynamically with out-of-band PKCE proxying.</p>
    </div>
  </div>
</section>
...
<section id="capabilities">
  ...
  <table>
    <thead>
      <tr><th>Capability</th><th>Smithery</th><th>wmcp.sh</th></tr>
    </thead>
    <tbody>
      <tr><td><strong>Local Subprocess Installation</strong></td><td>✅ Core feature, highly mature</td><td class="ours">❌ Out of scope — wmcp.sh runs on edge CDNs</td></tr>
      <tr><td><strong>Multi-Tenant SaaS Apps</strong></td><td>❌ Not supported (Docker per user is heavy)</td><td class="ours">✅ Highly scalable, stateless edge gateway</td></tr>
      <tr><td><strong>Out-of-band Key Vaulting</strong></td><td>❌ Not supported (local configs in plain-text)</td><td class="ours">✅ Built-in PKCE token isolation proxy</td></tr>
      <tr><td><strong>Dynamic OpenAPI Mapping</strong></td><td>❌ Must write curated servers</td><td class="ours">✅ Dynamic OpenAPI specs compiled at runtime</td></tr>
      ...
      <tr><td><strong>Cold-start cost</strong></td><td>⚠️ Docker pull + container boot on first launch (2–30s, then warm)</td><td class="ours">✅ No container — sub-50ms edge execution from first call</td></tr>
    </tbody>
  </table>
</section>
...
<section id="wins">
  ...
  <div class="wins-grid">
    <div class="wins-card">
      <h3>Smithery wins when:</h3>
      <ul>
        <li>You want to run existing open-source MCP servers locally</li>
        <li>You are building personal workflows on a single developer laptop</li>
        <li>You prefer isolating servers inside local Docker containers</li>
      </ul>
    </div>
    <div class="wins-card us">
      <h3>wmcp.sh wins when:</h3>
      <ul>
        <li>You are building multi-user SaaS web applications in the cloud</li>
        <li>You require dynamic, zero-codegen OpenAPI-to-MCP edge translation</li>
...
<span class="c"># Dynamic tools resolved instantly at edge POPs, no Docker installs.</span></code></pre>
</section>

<section id="faq">
  <div class="section-label">FAQ</div>
  <h2>Common questions.</h2>
  <details><summary>What's the difference?</summary><div class="answer">Smithery installs and runs MCP servers locally inside Docker containers. wmcp.sh translates public APIs and storefronts to standard tool schemas dynamically at the edge.</div></details>
  <details><summary>When pick Smithery?</summary><div class="answer">Local single-dev laptop configurations and Docker-based setups.</div></details>
